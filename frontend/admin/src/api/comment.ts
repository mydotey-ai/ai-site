...
export const commentApi = {
   ...
   * 获取评论详情
   */
  getById(id: bigint): Promise<Comment> {
   ...
   * 审核通过
   */
  approve(id: bigint): Promise<void> {
   ...
   * 批量审核通过
   */
  batchApprove(ids: bigint[]): Promise<void> {
   ...
   * 批量拒绝
   */
  batchReject(ids: bigint[]): Promise<void> {
